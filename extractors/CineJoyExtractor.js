...
(() => {
  ...
  function R(t, e, n = "") {
    if (it(t) && (e === void 0 || t.length === e)) return t;
    e !== void 0 && w(e, "length");
    let o = it(t),
      r = e !== void 0 ? " of length ".concat(e) : "",
      s = o ? "length=".concat(t.length) : "type=".concat(typeof t),
      f = et(n) + "expected Uint8Array" + r + ", got " + s;
    throw o ? new RangeError(f) : new TypeError(f);
  }
  function Q(t) {
  ...
  function W(t, e = !0) {
    if (t.destroyed) throw new Error("hash was destroyed");
    if (e && t.finished) throw new Error("digest() was already called");
  }
  function V(t, e) {
    R(t, void 0, "output");
    let n = e.outputLen;
    if (!(t.length >= n)) throw new RangeError('"output" expected length >= ' + n);
  }
  function Z(t) {
  ...
  var At = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
  function Et(t) {
  ...
  function ot(t, e = "") {
    return typeof t == "string" ? Bt(t) : R(t, void 0, e);
  }
  function z(t, e, n = "opts") {
    return xt(t, "defaults"), e !== void 0 && xt(e, n), Object.assign(t, e);
  }
  function ht(t, e = {}) {
  ...
  var v = class {
      constructor(e, n) {
        ...
        l(this, "finished", !1);
        l(this, "destroyed", !1);
        if (Q(e), R(n, void 0, "key"), this.iHash = e.create(), typeof this.iHash.update != "function") throw new Error("expected Hash instance");
        this.blockLen = this.iHash.blockLen, this.outputLen = this.iHash.outputLen;
        let o = this.blockLen,
          r = new Uint8Array(o);
        r.set(n.length > o ? e.create().update(n).digest() : n);
        for (let s = 0; s < r.length; s++) r[s] ^= 54;
  ...
  function St(t, e, n, o) {
    ...
    if (w(s, "c"), w(f, "dkLen"), w(c, "asyncTick"), s < 1) throw new Error('"c" (iterations) must be >= 1');
    if (f < 1) throw new Error('"dkLen" must be >= 1');
    if (f > (q(2, 32) - 1) * t.outputLen) throw new Error("derived key too long");
    let a = ot(e, "password"),
      i = ot(n, "salt"),
      d = new Uint8Array(f),
      {
  ...
  function rt(t, e, n, o) {
    ...
    for (let i = 1, d = 0; d < s; i++, d += c) {
      let x = f.subarray(d, d + c);
      a.u1(i, x), a.rounds(r, x);
    }
    return a.output(f);
  }
  var _t = t => t / q(2, 32) | 0,
  ...
  function Ft(t, e, n) {
    ...
    if (w(r, "N"), w(s, "r"), w(f, "p"), w(c, "dkLen"), w(a, "asyncTick"), w(i, "maxmem"), d !== void 0 && typeof d != "function") throw new Error('"onProgress" must be a function');
    if (s < 1) throw new Error('"r" expected integer >= 1');
    let x = 128 * s,
      u = x / 4,
      b = Math.pow(2, 32);
    if (r <= 1 || (r & r - 1) !== 0 || r > b) throw new Error('"N" expected a power of 2, and 2^1 <= N <= 2^32');
    if (f < 1 || f > (b - 1) * 32 / x) throw new Error('"p" expected integer 1..((2^32 - 1) * 32) / (128 * r)');
    if (c < 1 || c > (b - 1) * 32) throw new Error('"dkLen" expected integer 1..(2^32 - 1) * 32');
    let y = x * (r + f + 1);
    if (y > i) throw new Error('"maxmem" limit was hit: memUsed(128*r*(N+p+1))=' + y + ", maxmem=" + i);
    let p = rt(J, t, e, {
        c: 1,
        dkLen: x * f
      }),
  ...
  function mt(t, e, n) {
    ...
    for (let b = 0; b < s; b++) {
      let y = c * b;
      for (let p = 0; p < c; p++) a[p] = i[y + p];
      for (let p = 0, g = 0; p < o - 1; p++) ft(a, g, a, g += c, r), u();
      ft(a, (o - 1) * c, i, y, r), u();
      for (let p = 0; p < o; p++) {
        let g = (i[y + c - 16] & o - 1) >>> 0;
        for (let L = 0; L < c; L++) x[L] = i[y + L] ^ a[g * c + L];
        ft(x, 0, i, y, r), u();
      }
    }
    return nt(i), Dt(t, f, d, a, x);
  }
  window.nobleScrypt = mt;
  window.nobleSha256 = J;
})();
  ...
  function parseStream(decJson, server) {
    ...
    for (var i = 0; i < caps.length; i++) {
      ...
      if (capUrl) subtitles.push({ url: capUrl, lang: lang, label: lang });
    }
    return {
      url: streamUrl,
      quality: 'Auto',
