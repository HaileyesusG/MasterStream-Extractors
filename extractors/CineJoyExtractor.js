/**
 * CineJoyExtractor v5.5.0 — Zero-Backend Adaptive HLS Master Extractor for MasterStream.
 ...
 *
 * Architecture (100% Client-Side / Zero Render Bandwidth / Zero Backend Dependencies):
 ...
 * 7. Returns direct Master HLS stream (Auto) with full adaptive resolution switching (1080p/4K)
 *    and 100% synchronized multi-channel audio directly from CineJoy's CDN.
 */
(function () {
  'use strict';
